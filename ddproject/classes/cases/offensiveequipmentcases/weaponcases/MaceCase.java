...
import ddproject.classes.equipments.offensive.weapons.Mace;

public class MaceCase extends WeaponCase {

  public MaceCase(Player player) {
    super(player);
  }
  ...
  public void run(Player player){
    System.out.println("case " + player.getPosition() + "/" + 63 + " | You find a new mace");
    Weapon newWeapon = new Mace(virtualDice(5));
